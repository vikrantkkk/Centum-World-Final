...
import { myTechTeam1, myTechTeam2 } from "../constants";
...
const TeamSection = ({ title, data, sliderSettings }) => {
  ...
  return (
    <div className="">
      <div className="text-gray-300 text-3xl font-semibold w-full text-center mt-4">
        {title}
      </div>
...
const Founder = () => {
  ...
  const handleDownload = () => {
    const fileDownload = "brochure.pdf"; 
    saveAs(brochurePDF, fileDownload);
  };

  return (
    <>
      <div className="mt-20 ">
        <div className="text-center text-3xl font-semibold w-ful">
        Technical/Software
        </div>
        <TeamSection
        ...
        />
          ...
          >
            ...
            <button class="relative" onClick={ handleDownload }>
              Download Brochure
            </button>
          </a>
        </div>
