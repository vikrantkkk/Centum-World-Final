...
const ChatApp = () => {
  ...
  return (
    <div className="fixed bottom-10 right-14 z-50 flex justify-items-center">
      <button onClick={() => setOpenPopup((prev) => !prev)}>
        <SiGooglechat fontSize={40} className="bg-primary p-2 rounded-md" />
      </button>
      {openPopup && (
        <div className="absolute bottom-12 h-96 w-72 bg-secondary right-5 rounded-md flex flex-col justify-between">
